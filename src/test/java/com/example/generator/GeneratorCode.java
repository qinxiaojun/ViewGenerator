...
import com.example.constant.DisplayField;
import com.example.constant.SearchField;
...
public class GeneratorCode extends BaseTest {
     ...
     * 生成代码板位置
     */
    private static final String OUT_ROOT = "E:/generator/output";
    ...
    public static void genCode(String... tableNames) throws Exception {
        ...
        try {
            for (String tableName : tableNames) {
                DisplayField.setDisplayField(tableName, "id");
                SearchField.setSearchField(tableName, "{'account':'text','regTime':'singleDate','password':'select'}");
                // 删除旧文件
