...
<div class="layui-fluid">
    ...
    <div class="layui-card">
            ...
            <form class="layui-form layui-form-pane">
                ...
                <div class="layui-row layui-form-item">
                    <div class="layui-col-md4">
                        <label class="layui-form-label"><s:message
                                code="${className}Dto.${column.columnNameLower}"/></label>
                        <div class="layui-input-block">
                            <input type="text" id="search${column.columnName}" name="search${column.columnName}"
                                   class="layui-input" placeholder="<s:message code='commom.input.placeholder' />"/>
                        </div>
                    </div>
        ...
        <div class="layui-col-md4">
            ...
            <div class="layui-input-block">
                <input type="text" id="search${column.columnName}" name="search${column.columnName}" class="layui-input"
...
<div class="layui-row layui-form-item">
    <div class="layui-col-md2 layui-col-md-offset5">
        <button id="${classNameLower}TableQuery" type="button" class="layui-btn layui-btn-normal"><s:message
                code="common.button.query"/></button>
        <button id="${classNameLower}TableReset" type="reset" class="layui-btn layui-btn-danger"><s:message
                code="common.button.reset"/></button>
    </div>
</div>
</form>
</div>
            ...
            <div id="${classNameLower}Step-1">
                <form class="layui-form layui-form-pane" id="${classNameLower}Form">
                    ...
                    <div class="layui-row layui-form-item" style="display: none;">
                        ...
                        <input type="button" id="${classNameLower}FormVerify" lay-submit
                               lay-filter="${classNameLower}Form"/>
                    </div>
                    <#list table.columns as column>
                    <#if (column_index==0)>
                    <div class="layui-row layui-form-item">
...
<script language="Javascript"
        src="${r'${'}ctx${r'}'}/js/${modulepackage}/${classNameLower}/${classNameLower}.js"></script>
</body>
